...
public class Source {
    ...
    public static AppUser appUser1 = new AppUser(1, "abc@gmail.com", "123456", "Adam", "Green", AppUser.Role.ROLE_TEACHER, "12345964634");
    public static AppUser appUser2 = new AppUser(2, "def@gmail.com", "123456", "John", "Cole", AppUser.Role.ROLE_STUDENT, "13132423452");
    public static AppUser appUser3 = new AppUser(3, "ghi@gmail.com", "123456", "Tommy", "Brown", AppUser.Role.ROLE_STUDENT, "1234124235");
    public static Course course = new Course(1, "Course", "New Course", appUser1, Arrays.asList(appUser2, appUser3));
